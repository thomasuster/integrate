...
var com_thomasuster_sys_js_WebSocketClient = function() {
	this.commands = [];
};
com_thomasuster_sys_js_WebSocketClient.__name__ = ["com","thomasuster","sys","js","WebSocketClient"];
com_thomasuster_sys_js_WebSocketClient.prototype = {
	connect: function() {
...
massive_munit_client_ExternalPrintClientJS.prototype = {
	...
	,queue: function(method,args) {
		...
		return eval(this.convertToJavaScript(method,a));
	}
...
org_hamcrest_BaseDescription.prototype = {
	...
	,appendValue: function(value) {
		if(value == null) {
			...
			this.escapeAndAppend(js_Boot.__cast(value , String));
		} else if(org_hamcrest_internal_TypeIdentifier.isIterable(value)) {
	...
	,appendList: function(start,separator,end,values) {
		...
		while(value.hasNext()) {
			...
			this.appendDescriptionOf(value1);
			separate = true;
		}
		this.append(end);
		return this;
...
org_hamcrest_MatcherAssert.assertThat = function(actual,matcher,reason,info) {
	...
	if(matcher != null) {
		...
		if(!actual) {
			throw new js__$Boot_HaxeError(new org_hamcrest_AssertionException(reason,null,info));
		}
	} else {
		throw new js__$Boot_HaxeError(new org_hamcrest_IllegalArgumentException("If no Matcher defined then 'actual' must be of type Bool.",null,{ fileName : "MatcherAssert.hx", lineNumber : 49, className : "org.hamcrest.MatcherAssert", methodName : "assertThat"}));
	}
};
...
org_hamcrest_core_IsEqual.areEqual = function(valueOne,valueTwo) {
	...
	} else if(valueTwo != null && org_hamcrest_core_IsEqual.isArray(valueOne)) {
		if(org_hamcrest_core_IsEqual.isArray(valueTwo)) {
			return org_hamcrest_core_IsEqual.areArraysEqual(valueOne,valueTwo);
		} else {
			return false;
		}
	} else if(valueTwo != null && org_hamcrest_core_IsEqual.isEnum(valueOne)) {
		if(org_hamcrest_core_IsEqual.isEnum(valueTwo)) {
			return org_hamcrest_core_IsEqual.areEnumsEqual(valueOne,valueTwo);
		} else {
			return false;
		}
	} else {
...
org_hamcrest_core_IsEqual.areArraysEqual = function(valueOne,valueTwo) {
	if(org_hamcrest_core_IsEqual.areArrayLengthsEqual(valueOne,valueTwo)) {
		return org_hamcrest_core_IsEqual.areArrayElementsEqual(valueOne,valueTwo);
	} else {
		return false;
	}
};
...
org_hamcrest_core_IsEqual.areArrayElementsEqual = function(valueOne,valueTwo) {
	...
	while(_g1 < _g) {
		var i = _g1++;
		if(!org_hamcrest_core_IsEqual.areEqual(valueOne[i],valueTwo[i])) {
			return false;
		}
	}
	return true;
...
org_hamcrest_core_IsEqual.isArray = function(value) {
	if((value instanceof Array)) {
		return value.__enum__ == null;
	} else {
		return false;
	}
};
org_hamcrest_core_IsEqual.isEnum = function(value) {
	if(Type["typeof"](value)[1] == 7) {
		return true;
	} else {
		return false;
	}
...
org_hamcrest_internal_TypeIdentifier.isIterable = function(value) {
	...
	if(hasNextField != null && nextField != null && Reflect.isFunction(hasNextField) && Reflect.isFunction(nextField)) {
		return true;
	}
	return false;
};
...
org_hamcrest_internal_TypeIdentifier.isComparablePrimitive = function(value) {
	if(!org_hamcrest_internal_TypeIdentifier.isNumber(value)) {
...
org_hamcrest_internal_TypeIdentifier.isComparable = function(value) {
	...
	if(org_hamcrest_internal_TypeIdentifier.isComparablePrimitive(value)) {
		return true;
	}
	if(js_Boot.__instanceof(value,Date)) {
		return true;
	}
	if(org_hamcrest_internal_TypeIdentifier.hasCompareToFunction(value)) {
		return true;
	}
	return false;
};
